...
contract('ERC721Votes', function (accounts) {
  ...
  describe('balanceOf', function () {
    beforeEach(async function () {
      ...
      await this.votes.$_mint(account1, this.NFTCollection);
  ...
  describe('transfers', function () {
    ...
    it('generally returns the voting balance at the appropriate checkpoint', async function () {
      ...
      await time.advanceBlock();
      await time.advanceBlock();
      const t3 = await this.votes.transferFrom(account1, other2, this.NFTCollection, { from: account1 });
      await time.advanceBlock();
      await time.advanceBlock();
      const t4 = await this.votes.transferFrom(other2, account1, this.NFTCollection, { from: other2 });
      await time.advanceBlock();
      await time.advanceBlock();
